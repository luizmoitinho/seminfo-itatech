<div class="container flex-column margin-bottom bg-white container-div">
    ...
    <div class="col-md-8 margin-bottom-1 atividades font-weight-normal cronograma-atividade">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="palestra_dia_1-tab" data-toggle="tab" href="#palestra_dia_1" role="tab"
                    aria-controls="palestra_dia_1" aria-selected="true">11/12/19</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="palestra_dia_2-tab" data-toggle="tab" href="#palestra_dia_2" role="tab"
                    aria-controls="palestra_dia_2" aria-selected="false">12/12/19</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="palestra_dia_3-tab" data-toggle="tab" href="#palestra_dia_3" role="tab"
                    aria-controls="palestra_dia_3" aria-selected="false">13/12/19</a>
            </li>
        </ul>
    </div>
...
<div class="container container-div margin-bottom bg-white">
    ...
    <div class="row">
            <table class="table minicursos table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Arduino</td>
                        <td>Arduino</td>
                        <td>Web API com ASP.Net Core</td>
                        <td>Web API com ASP.Net Core</td>
                    </tr>
                    <tr>
